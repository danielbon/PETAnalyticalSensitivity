...
def analyse_all_folders(output_folders, **kwargs):
    ...
    legend_text = ['LYSO-20 mm', 'BGO-15 mm', 'BGO/'+fast_mat+'-20 mm',  'BGO/'+fast_mat+'-25 mm',  'LYSO/'+fast_mat+'-25 mm',  'LYSO/'+fast_mat+'-30 mm', 'LYSO/'+fast_mat+'-35 mm']
    ########### END OF USER SECTION ###########################################################
    ...
    MgrAxialSensnoEW.SetMaximum(85.)
