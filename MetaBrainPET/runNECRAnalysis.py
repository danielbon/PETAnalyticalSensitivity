...
# -*- coding: utf-8 -*-
# 
# ../../runNECRAnalysis.py LYSO-Proteus/ BGO/ BGO_BaF2_25/ BGO_EJ232_25/ LYSO-Proteus_BaF2_25/ LYSO-Proteus_EJ232_25/ LYSO-Proteus_BaF2_30/ LYSO-Proteus_EJ232_30/ > ./nec-output_all.txt
# ../../runNECRAnalysis.py LYSO-Proteus/ BGO/ BGO_BaF2_23.2/ BGO_EJ232_22.5/ LYSO-Proteus_BaF2_29.7/ LYSO-Proteus_EJ232_31.1/ > ./nec-output_all.txt
# ../../runNECRAnalysis.py LYSO-Proteus/ BGO/ BGO_BaF2_23.7/ BGO_EJ232_22.7/ LYSO-Proteus_BaF2_31.1/ LYSO-Proteus_EJ232_32.3/ > ./nec-output_all.txt
# ../../runNECRAnalysis.py LYSO-Proteus/ BGO/ BGO_BaF2_23.2/ BGO_EJ232_22.5/ > ./nec-output_all.txt
...
def analyse_all_folders(output_folders, **kwargs):
    ...
    print("")
    grNECR.Draw('APL')
    legend = ROOT.TLegend(0.45, 0.62, 0.99, 0.98)
    for index, output_folder in enumerate(output_folders, start=0):
        legend.AddEntry(grNECREW[index] ,get_legend_text(output_folder))
    legend.Draw('same')
    c1.Update()
    c1.Print(output_folder+"../necr_EW.pdf")
    r = True
    return r
