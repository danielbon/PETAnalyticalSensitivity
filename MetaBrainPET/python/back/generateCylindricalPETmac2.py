...
CSizeX = 20.00 #crystal thickness
#module array
NModZ = 2 #number of rings
ModPitchSizeZ = CSizeZ + 4.80
NModY = 1
...
# NrsectorPerRing = 8 #number of heads per ring (manual method)
...
f = open('cylindricalPETpy.mac','w')
f.write('# This macro describes a PET scanner based on monolithic crystal detector blocks')
f.write('\n' + '# each block consists of a ' + str(CSizeY) + 'x' + str(CSizeZ) + ' x ' + str(CSizeX) + ' mm3 crystal coupled to a SiPM array')
...
f.write('\n' + '/gate/crystal/setMaterial LYSO-Ce-Hilger')
