...
# Python script to generate a GATE macro to describe a PET scanner based on pixelated crystal
...
f.write('\n' + '/gate/cylindricalPET/geometry/setRmax ' + str(XOpticalSystem) + ' mm')
f.write('\n' + '/gate/cylindricalPET/geometry/setRmin ' + str(YOpticalSystem) + ' mm')
f.write('\n' + '/gate/cylindricalPET/geometry/setHeight ' + str(ZOpticalSystem) + ' mm')
