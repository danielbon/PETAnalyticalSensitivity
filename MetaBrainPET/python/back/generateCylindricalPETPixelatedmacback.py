# generateCylindricalPETPixelatedmac.py
...
CSizeX = 15.00 #crystal thickness
#module array
NModZ = 2 #number of rings
ModPitchSizeZ = CSizeZ + 1
NModY = 1
ModPitchSizeY = CSizeY + 1
#ring or rsector
...
f.write('\n' + '/gate/OpticalCoupling/vis/setVisible 1')
f.write('\n')
# === SiPM cover window ===
...
f.write('\n' + '/gate/SiPMCover/vis/setVisible 1')
f.write('\n')
# === SiPM ===
