...
f.write('\n' + '/gate/LYSO-Proteus/placement/setTranslation 0.0 0.0 ' + str(-MetaPixelZLYSO/2) + ' mm')
f.write('\n' + '/gate/LYSO-Proteus/geometry/setXLength ' + str(Xcrystal) + ' mm')
f.write('\n' + '/gate/LYSO-Proteus/geometry/setYLength ' + str(Ycrystal) + ' mm')
f.write('\n' + '/gate/LYSO-Proteus/geometry/setZLength ' + str(MetaPixelZLYSO) + ' mm')
...
f.write('\n' + '/gate/LYSO-Proteus/cubicArray/setRepeatNumberZ ' + str(NMetaPixelZLYSO))
f.write('\n' + '/gate/LYSO-Proteus/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZBaF2+MetaPixelZLYSO) + ' mm')
...
f.write('\n' + '/gate/crystal/daughters/insert box')
f.write('\n' + '/gate/BaF2/placement/setTranslation 0.0 0.0 ' + str(MetaPixelZBaF2/2) + ' mm')
f.write('\n' + '/gate/BaF2/geometry/setXLength ' + str(Xcrystal) + ' mm')
f.write('\n' + '/gate/BaF2/geometry/setYLength ' + str(Ycrystal) + ' mm')
f.write('\n' + '/gate/BaF2/geometry/setZLength ' + str(MetaPixelZBaF2) + ' mm')
...
f.write('\n' + '/gate/BaF2/cubicArray/setRepeatNumberZ ' + str(NMetaPixelZBaF2))
f.write('\n' + '/gate/BaF2/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZBaF2+MetaPixelZLYSO) + ' mm')
