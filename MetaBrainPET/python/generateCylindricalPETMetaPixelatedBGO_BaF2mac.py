...
f.write('\n' + '/gate/BGO/placement/setTranslation 0.0 0.0 ' + str(-MetaPixelZBGO/2) + ' mm')
...
f.write('\n' + '/gate/BGO/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZBaF2+MetaPixelZBGO) + ' mm')
...
f.write('\n' + '/gate/BaF2/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZBaF2+MetaPixelZBGO) + ' mm')
