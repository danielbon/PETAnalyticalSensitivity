...
f.write('\n' + '/gate/LYSO-Proteus/placement/setTranslation 0.0 0.0 0.0 mm')
...
f.write('\n' + '/gate/LYSO-Proteus/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZEJ232+MetaPixelZLYSO) + ' mm')
...
f.write('\n' + '/gate/EJ232/cubicArray/setRepeatVector 0. 0. ' + str(MetaPixelZEJ232+MetaPixelZLYSO) + ' mm')
