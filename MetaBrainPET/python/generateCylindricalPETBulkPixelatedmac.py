# Python script to generate a GATE macro to describe a PET scanner
import math
...
f = open('cylindricalPETBulkpy.mac','w')
...
f.write('\n')
f.write('\n' + '# ' + crystalmaterial + ' layer {Setting the dimensions of each crystal layer}')
f.write('\n' + '/gate/crystal/daughters/name ' + crystalmaterial)
f.write('\n' + '/gate/crystal/daughters/insert box')
f.write('\n' + '/gate/' + crystalmaterial + '/placement/setTranslation 0.0 0.0 0.0 mm')
f.write('\n' + '/gate/' + crystalmaterial + '/geometry/setXLength ' + str(Xcrystal) + ' mm')
f.write('\n' + '/gate/' + crystalmaterial + '/geometry/setYLength ' + str(Ycrystal) + ' mm')
f.write('\n' + '/gate/' + crystalmaterial + '/geometry/setZLength ' + str(Zcrystal) + ' mm')
f.write('\n' + '/gate/' + crystalmaterial + '/setMaterial ' + crystalmaterial)
f.write('\n' + '/gate/' + crystalmaterial + '/vis/forceWireframe')
f.write('\n' + '/gate/' + crystalmaterial + '/vis/setColor green')
f.write('\n' + '/gate/' + crystalmaterial + '/vis/setVisible 1')
f.write('\n')
f.write('\n' + '# === Optical coupling ===')
...
f.write('\n' + '/gate/systems/cylindricalPET/layer0/attach ' + crystalmaterial)
f.write('\n')
f.write('\n' + '# Attach CrystalSD')
f.write('\n' + '/gate/' + crystalmaterial + '/attachCrystalSD')
