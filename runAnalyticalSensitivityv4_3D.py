...
# ./runAnalyticalSensitivityv4.py ./output/Sensitivity > ./output/Sensitivity/AnalyticalSensitivity.txt
...
def analyse_all_folders(output_folder, **kwargs):
    ...
    legend_text = [' - AM (511 keV)', ' - AM (^{22}Na)', ' - GATE (^{22}Na)', ' - GATE (511 keV)', ' - AM (upper bound)', ' - AM (lower bound)']
    BulkArea = 9.0 #mm2
    ...
    LYSO = [("Lu18Y2Si10O50", 7.1, BulkArea)]
    BGO = [("Bi4Ge3O12", 7.13, BulkArea)]
    LYSO_BaF2 = [("Lu18Y2Si10O50", 7.1, AreaHZBaF2), ("BaF2", 4.88, AreaBaF2)]
    BGO_BaF2 = [("Bi4Ge3O12", 7.13, AreaHZBaF2), ("BaF2", 4.88, AreaBaF2)]
    LYSO_EJ232 = [("Lu18Y2Si10O50", 7.1, AreaHZEJ232), ("C466H513", 1.023, AreaEJ232)]
    BGO_EJ232 = [("Bi4Ge3O12", 7.13, AreaHZEJ232), ("C466H513", 1.023, AreaEJ232)]
    Material_Scint = [LYSO, BGO , LYSO_BaF2, BGO_BaF2, LYSO_EJ232, BGO_EJ232]
    AxialPositions = array( 'f', [ -75., -45., -15., 0., 15., 45., 75. ] )
    ...
    input_filename = 'GateData/Gate511keVnoEW90.dat'
    GateS511keVnoEW = read_input(input_filename)
    input_filename = 'GateData/Gate511keVEW90.dat'
    GateS511keVEW = read_input(input_filename)
    input_filename = 'GateData/GateNa22noEWshort.dat'
    ...
    for j, Scintillator in enumerate(Scintillators[start:stop], start=start):
        ...
        S511keVnoEW = array( 'f', sens.compute_axial3D_array("total", "511 keV", AxialPositions, radial_pos, 1))
        grAS511keVnoEW.append(ROOT.TGraph( n_pos, AxialPositions,  S511keVnoEW))
        SNa22noEW = array( 'f', sens.compute_axial3D_array("total", "sodium-22", AxialPositions, radial_pos, 1))
        ...
        S511keVPheEW = array( 'f', sens.compute_axial3D_array("upper_bound","511 keV", AxialPositions, radial_pos, 1))
        ...
        S511keVFitEW = array( 'f', sens.compute_axial3D_array("lower_bound","511 keV", AxialPositions, radial_pos, 1))
        ...
        #dfEW.loc[Scintillator] = [sens.compute_axial("upper_bound","511 keV", 0., 1), sens.compute_axial("photoelectric","511 keV", 0., 1), max(ref_data_511keVEW)]
